...
break;
case 2:this.$ = ($$[$0-3+1-1] * 1) <= ($$[$0-3+3-1] * 1);
break;
case 3:this.$ = ($$[$0-3+1-1] * 1) >= ($$[$0-3+3-1] * 1);
break;
case 4:this.$ = ($$[$0-3+1-1] * 1) != ($$[$0-3+3-1] * 1);
break;
case 5:this.$ = ($$[$0-3+1-1] * 1) != ($$[$0-3+3-1] * 1);
break;
case 6:this.$ = ($$[$0-3+1-1] * 1) > ($$[$0-3+3-1] * 1);
break;
case 7:this.$ = ($$[$0-3+1-1] * 1) < ($$[$0-3+3-1] * 1);
break;
case 8:this.$ = jSE.cFN.sanitize($$[$0-3+1-1]) + jSE.cFN.sanitize($$[$0-3+3-1]);
break;
case 9:this.$ = ($$[$0-3+1-1] * 1) - ($$[$0-3+3-1] * 1);
break;
case 10:this.$ = ($$[$0-3+1-1] * 1) * ($$[$0-3+3-1] * 1);
break;
case 11:this.$ = ($$[$0-3+1-1] * 1) / ($$[$0-3+3-1] * 1);
break;
case 12:this.$ = Math.pow(($$[$0-3+1-1] * 1), ($$[$0-3+3-1] * 1));
break;
case 13:this.$ = $$[$0-2+2-1] * -1;
break;
case 14:this.$ = $$[$0-3+2-1];
break;
case 15:this.$ = ($$[$0-1+1-1].replace(/%/,'') * 1) / 100;
break;
case 16:/*this.$ = new Date($$[$0-1+1-1]).toString();*/
break;
case 17:this.$ = Number(yytext);
break;
case 18:this.$ = Math.E;
break;
case 19:this.$ = arguments[6].fixedCellValue.apply(arguments[7], [$$[$0-1+1-1]]);
break;
case 20:this.$ = arguments[6].fixedCellRangeValue.apply(arguments[7], [$$[$0-1+1-1]]);
break;
case 21:this.$ = arguments[6].cellValue.apply(arguments[7], [$$[$0-1+1-1]]);
break;
case 22:this.$ = arguments[6].cellRangeValue.apply(arguments[7], [$$[$0-1+1-1]]);
break;
case 23:this.$ = arguments[6].remoteCellValue.apply(arguments[7], [$$[$0-1+1-1]]);
break;
case 24:this.$ = arguments[6].remoteCellRangeValue.apply(arguments[7], [$$[$0-1+1-1]]);
break;
case 25:this.$ = $$[$0-1+1-1].substring(1, $$[$0-1+1-1].length - 1);
break;
case 26:this.$ = arguments[6].callFunction($$[$0-3+1-1], '', arguments[7]);
break;
...
lexer.rules = [/^\s+/,/^"(\\["]|[^"])*"/,/^'(\\[']|[^'])*'/,/^\$[A-Za-z]+\$[0-9]+[:]\$[A-Za-z]+\$[0-9]+/,/^\$[A-Za-z]+\$[0-9]+/,/^SHEET[0-9]+[:!][A-Za-z]+[0-9]+[:][A-Za-z]+[0-9]+/,/^SHEET[0-9]+[:!][A-Za-z]+[0-9]+/,/^[A-Za-z]+[0-9]+[:][A-Za-z]+[0-9]+/,/^[A-Za-z]+[0-9]+/,/^[A-Za-z]+/,/^[0-9]([0-9]?)[-/][0-9]([0-9]?)[-/][0-9]([0-9]?)([0-9]?)([0-9]?)/,/^[0-9]+[%]/,/^[0-9]+(\.[0-9]+)?/,/^\$/,/^ /,/^\./,/^:/,/^;/,/^,/,/^\*/,/^\//,/^-/,/^\+/,/^\^/,/^\(/,/^\)/,/^>/,/^</,/^>=/,/^<=/,/^<>/,/^NOT\b/,/^PI\b/,/^E\b/,/^"/,/^'/,/^!/,/^$/,/^=/];return lexer;})()
parser.lexer = lexer;
return parser;
})();
