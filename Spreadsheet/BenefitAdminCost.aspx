<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BenefitAdminCost.aspx.cs" Inherits="WebAppProject.BenefitAdminCost" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;<table bgcolor="White" 
            style="width: 100%; height: 25px;" width="100%">
            <tr>
                <td class="style1">
...
&nbsp;To sheet
                    <asp:DropDownList ID="DropDownListTo" runat="server" Height="18px" 
                        ...
                        <asp:ListItem>Activity Cost</asp:ListItem>
                    </asp:DropDownList>
