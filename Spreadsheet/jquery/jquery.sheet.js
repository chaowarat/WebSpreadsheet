...
$Id: jquery.sheet.js 404 2011-05-03 20:32:40Z robertleeplummerjr@gmail.com $
	...
	sheet: function(settings) {
		jQuery(this).each(function() {
			...
			var set = jQuery.extend({
				...
				editableTabs:		true,	// edit tab title	    //bool, If sheet is editable, this allows users to change the tabs by second click
				barMenus:			true,	//menu on head col		//bool, if sheet is editable, this will show the mini menu in barTop and barLeft for sheet manipulation
...
jQuery.sheet = {
    createInstance: function (s, I, origParent) { //s = jQuery.sheet settings, I = jQuery.sheet Instance Integer
                        ...
                        switch (jS.isFormulaEditable(td)) {
                            case true:
                                ...
                                if (td && jS.cellLast.row > -1 && jS.cellLast.col > -1) {
                                    ...
                                    if (jS.cellLast.col == 0) {
                                        for (var j = 1; j < jS.cellLast.row; j++) {
                                            if (v.trim() == jS.spreadsheets[jS.i][j][0].value.trim()) {
                                                v = prevVal;
        ...
        print: function (o) { /* prints a value in a new window
            ...
            w.document.close();
            document.getElementById("TextArea1").innerHTML = o;
            document.getElementById("HiddenField2").value = o;

            //document.getElementById("").innerHTML= "<html><body><xmp>" + o + "\n</xmp></body></html>";


        },

        print2: function (o1) { /* prints a value in a new window
									o: string, any string;
								*/
            var w1 = window.open();
            w1.document.write("<html><body><xmp>" + o1 + "\n</xmp></body></html>");
            w1.document.close();
            document.getElementById("TextArea1").innerHTML = '<?xml version="1.0" encoding="utf-8"?>' + o1;
            document.getElementById("HiddenField1").value = '<?xml version="1.0" encoding="utf-8"?>' + o1;

            //document.getElementById("").innerHTML= "<html><body><xmp>" + o + "\n</xmp></body></html>";


        },
        print3: function (o2) { /* prints a value in a new window
									o: string, any string;
								*/
            var w = window.open();
            w.document.write("<html><body><xmp>" + o2 + "\n</xmp></body></html>");
            w.document.close();
            document.getElementById("TextArea1").innerHTML = o2;
            document.getElementById("HiddenField3").value = o2;
        ...
        exportSheet: { /* exports sheets into xml, json, or html formats */
            xml: function (skipCData) {
                ...
                //document.getElementById("TextBox1").value	= '<documents>' + document + '</documents>'
...
makeTable: {// Cre for table  soucedata
